//Ques 1 - What are objects in javascript?
...
// Job : "Freelancer"
// }
// Here, name, age and Job are keys and Shruti, 23 and Freelancer are values.
// the (name:Shruti) pair is called the property and student is the object.
...
//Ques 3 - What is an event loop and call stack.
...
//Quest 5 - Difference between undefined vs not defined vs NaN
...
//Quest 7 - What is the for-in loop in JavaScript? Give its syntax.
...
//Ques 8 - Explain Local Scope, Block Scope, Functional Scope and Scope Chain in javascript.
...
//Ques 9 - What is difference between null and undefined and where to use what?
...
//Ques 10 - Write code to explain map and filter in arrays.
...
// const arr = ["Shruti", "The", "Developer"];
// console.log(arr.filter(word => word.length > 4));


//Ques 11 - Given an array of 0's and 1's find out number of 0's.
...
console.log("The total No. of a is : ", a);
console.log("The total No. of b is : ", b);


//Ques 12 - Given an array find out total no. of odd and even nos.
...
console.log("The total Number of EvenNum are : ", EvenNum);
console.log("The total Number of OddNum are : ", OddNum);


//Ques 13 - Given a string find out number of vowels.

let str = "Shruti Dubey";
